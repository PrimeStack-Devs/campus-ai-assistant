    ...
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-35 lg:static flex flex-col bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-all duration-300 ${
          isOpen ? 'w-72 shadow-2xl lg:shadow-none' : 'w-0 -translate-x-full lg:w-0 lg:translate-x-0'
        } overflow-hidden`}
      >
        <div className="w-72 flex flex-col h-full">
          ...
          <div className="p-3">
            <Button
              onClick={onNewChat}
              className="w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-semibold flex items-center justify-center gap-2 rounded-xl py-2.5 shadow-md shadow-indigo-500/20 transition-all duration-200 active:scale-98"
            >
              <Plus size={18} />
              <span>New Chat</span>
            </Button>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-lg transition-all"
                  >
                    <Trash2 size={13} />
                  </button>
                </div>
          ...
          <div className="p-3 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
            <button
              ...
              className="w-full flex items-center justify-between p-2.5 rounded-xl border border-slate-200/60 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-indigo-800/60 bg-white dark:bg-slate-900 shadow-xs hover:shadow-sm transition-all text-left group"
            >
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="truncate">
                  <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors truncate">
                    Engineering Team
                  </p>
              ...
              <Users size={14} className="text-slate-400 group-hover:text-indigo-500 shrink-0 transition-colors" />
            </button>
          </div>
        </div>
      </aside>
